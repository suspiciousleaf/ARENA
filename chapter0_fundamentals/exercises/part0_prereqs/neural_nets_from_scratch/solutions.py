...
def forward(
    ...
    after_layer_0 = tensor_relu(
        apply_linear_function_to_input(neural_net.layer_0, x) + neural_net.layer_0_bias
    )
    after_layer_1 = tensor_relu(
        apply_linear_function_to_input(neural_net.layer_1, after_layer_0)
        + neural_net.layer_1_bias
    )
    # Instead of doing a ReLU at the very end, we're going to use softmax
    after_layer_2 = t.nn.functional.softmax(
        apply_linear_function_to_input(neural_net.layer_2, after_layer_1)
